                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 shadow sm:rounded-lg">
                            <div className="mt-2">
                                ...
                                <TextInput id='user_name' type="text" name="name" value={data.name}
                            ...
                            <div className="mt-2">
                                ...
                                <TextInput id='user_password' type="text" name="password" value={data.password}
                                           className="mt-1 block w-full"
                            ...
                            <div className="mt-2">
                                ...
                                <TextInput id='user_password_confirmation' type="password" name="password_confirmation" value={data.password_confirmation}
                                           className="mt-1 block w-full"
